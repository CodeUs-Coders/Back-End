...
public class MemberUpdateRequestDto {
    ...
    @Builder
    public MemberUpdateRequestDto(Long mem_no, String id, String pw, String name, String
            birth, String nickname, String img, String link, String msg, Role role) {
        this.mem_no = mem_no;
        this.id = id;
        this.pw = pw;
        this.name = name;
    ...
    public Member toEntity() {
        return Member.builder().mem_no(mem_no).id(id).pw(pw).birth(birth).nickname(nickname).img(img).link(link).msg(msg).role(role).build();
    }
